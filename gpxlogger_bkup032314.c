...
static void print_fix(struct gps_data_t *gpsdata, double time)
{
	...
	(void)fprintf(logfile,"    <lon_err>%f</lon_err>\n", gpsdata->fix.epx);//Lon Error - added by Arvi
	if ((isnan(gpsdata->fix.altitude) == 0))
		{
		(void)fprintf(logfile,"    <ele>%f</ele>\n", gpsdata->fix.altitude);
		(void)fprintf(logfile,"    <ele_err>%f</ele_err>\n", gpsdata->fix.epv);//elevation Error - added by Arvi
		(void)fprintf(logfile,"    <climb>%f</climb>\n", gpsdata->fix.track);//climb rate- added by Arvi
		}
	(void)fprintf(logfile,"    <speed>%f</speed>\n", gpsdata->fix.speed);//speed - added by Arvi
	(void)fprintf(logfile,"    <speed_err>%f</speed_err>\n", gpsdata->fix.eps);//speed Error - added by Arvi
	(void)fprintf(logfile,"    <track>%f</track>\n", gpsdata->fix.track);//track\heading - added by Arvi
